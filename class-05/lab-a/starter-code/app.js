...
function multiply(a, b) { //eslint-disable-line
    ...
    var multiplyArray = [
        mult,
        'The product of '+a+' and '+b+' is '+mult+'.'
    ]
...
function sumAndMultiply(a, b, c) { //eslint-disable-line
    ...
    var returnArray = [
        ...
        'The product of '+a+' and '+b+ ' and '+ c + ' is '+totalMult+'.'
    ]
    return returnArray;
}
...
function sumArray(sumArr) { //eslint-disable-line
        ...
        var returnArray = [
            totalSum,
            sumArr[0] + ',' + sumArr[1] + ',' + sumArr[2] + ' was passed in as an array of numbers, and ' + totalSum + ' is their sum.'
        ]
        return returnArray;
    }
...
whose first element is the product of those numbers, and the second element is a string that 
...
function multiplyArray(multArr) { //eslint-disable-line
    var firstMult = multiply(multArr[0],multArr[1])[0];
    var totalMult = multiply(firstMult, multArr[2])[0];
    var returnArray = [
        totalMult,
        "The numbers " +multArr[0] + ',' + multArr[1] + ',' + multArr[2] + ' have a product of ' + totalMult + '.'
    ]
    return returnArray;
...
returns an array whose first element is the product of those numbers, and the second element is a string that
 EXACTLY follows this example and concatenates a message using the arguments that were passed into the 
 unction:
...
function multiplyAnyArray(dynamicArray) { //eslint-disable-line
    ...
    for (let index = 0; index < (dynamicArray.length); index++) {
        var mult = multiply(mult,dynamicArray[index])[0];
        var returnArray = [
        mult,
        "The numbers " + dynamicArray + " have a product of " + mult + "."
    ]
}
    return returnArray
