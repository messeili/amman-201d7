...
var catAdoptionForm = document.getElementById("catAdoptionForm");

catAdoptionForm.addEventListener('submit', function(){
    ...
    var catAgeValue = event.target.catAge.value;
    console.log(catAgeValue);

    var catColorValue = event.target.catColor.value;
    console.log(catColorValue);

    var favThingsValue = event.target.favThings.value.split(',');
    console.log(favThingsValue);

    var catBreedValue = event.target.catBreed.value;
    console.log(catBreedValue);

    var isGoodWithDogsValue = event.target.isGoodWithDogs.checked;
    console.log(isGoodWithDogsValue);

    var isGoodWithKidsValue = event.target.isGoodWithKids.checked;
    console.log(isGoodWithKidsValue);

    var isGoodWithOtherCatsValue = event.target.isGoodWithOtherCats.checked;
    console.log(isGoodWithOtherCatsValue);
